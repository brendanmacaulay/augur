              ...
              {SCALE.map((likelihood) => {
                ...
                return (
                  <button
                    ...
                    className={`relative m-0.5 flex h-16 flex-1 items-center justify-center rounded-md transition hover:brightness-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 dark:focus-visible:ring-white sm:h-20 ${
                      band.cell
                    } ${
                      selected
